...
public class LoginRequest extends StringRequest { // hérite de stringRequest , classe de la bibliotheque Volley,
                                                  // necessaire a l'utilsiation de l'architecture REST
    ...
    {
        super(Method.POST,LOGIN_REQUEST_URL,listener,null);      // on utilise un conteneur de type clé - valeur
                                                                 // pour stocker les informations renseignées dans formulaire
